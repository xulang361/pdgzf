...
// 改成你的accessToken
const accessToken = 'eyJhbGciOiJIUzIYi1lZTQzODExZTUzODIiLCJpYXQiOjE3Mjk2MDkxMzUsImV4cCI6MTcyOTY5NTUzNX0.P6gp9EeGrk3dP11_L1m6OSZdpsGeM-BgYy-tnPp3ryo'
...
async function main() {
  try {
    ...
    for (let i = 0; i < allHouseList.length; i++) {
      ...
      // 添加延迟以避免请求过于频繁
      await delay(Math.random() * 200 ); // 随机延迟 0 - 300毫秒
    }
